...
<script type="text/javascript">
		function refreshImg(){
            ...
            $.ajaxFileUpload({  
	        	url: '<%=basePath%>back/uploadMsgMainImg.do?tm='+time, //后台提交地址  
                secureuri: false,//异步 "
						...
						<div class="widget-body">
							...
							<div class="widget-main">
								<div class="step-content row-fluid position-relative">
									...
									<form action="<%=basePath%>back/addMsg" name="msgForm" id="msgForm" method="post">
										<div id="zhongxin">
												...
												<tr>
													...
													<td>
														<select name="toType" id="toType">
															...
															<option value="1">优惠会员</option>
															<option value="2">经销会员</option>
														</select>
													</td>
												</tr>
												<tr>
