...
<div id="registerDIV" >
	<h4>会员注册</h4>
	<ul>
	      <li><label for="newname">*会员姓名: </label><input type="text" id="newname" name="newMemberName" /></li>
	      <li>
	      	<label>*性别：</label>
	      ...
	      <li><label>*身份证号: </label><input type="text" id="idcardNo" name="idcardNo" /></li>
	      <li><label >密码: </label><input type="password" id="newpw" name="password" /></li>
	      <li><label >密码确认: </label><input type="password" id="newpwCert" name="passwordCert" /></li>
	      <li>
	      	<label>*电话号码：</label>
	      	<input type="text" id="phone" name="phone"><img id="rightImg" src="<%=basePath %>static/images/timg.jpg" style="display: none"><button id="getcodebtn" onclick="getcode()">获取验证码</button><label>（有效时长：5分钟）</label>
	      </li>
	      <li>
	      	<label>请输入验证码：</label>
	      	<input id="smsCode" id="smsCode" name="smsCode">
	      </li>
	      <li>
